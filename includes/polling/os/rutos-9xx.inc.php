...
# Mobile Data Usage
$tlt_array = array(
    '.1.3.6.1.4.1.48690.2.19.0',
    '.1.3.6.1.4.1.48690.2.20.0',
);

$usage = snmp_get_multi_oid($device, $tlt_array);

$usage_sent = $usage['.1.3.6.1.4.1.48690.2.19.0'];
$usage_received = $usage['.1.3.6.1.4.1.48690.2.20.0'];
...
if ($usage_sent >= 0 && $usage_received >= 0) {
    $rrd_def = RrdDefinition::make()
        ...
        data_update($device, 'rutos_9xx_mobileDataUsage', $tags, $fields);
        $graphs['rutos_9xx_mobileDataUsage'] = true;
}
